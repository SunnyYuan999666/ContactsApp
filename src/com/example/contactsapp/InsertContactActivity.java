...
import com.example.contactsapp.modle.ContactModle;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.actionEditdone) {
            ...
            if (mIsFromNotification) {
                Log.e(TAG, "mIsFromNotification = true");
                intent.putExtra(IS_INSERT_CONTACT_ACTIVITY, true);
            ...
            if (mIsFromNotification) {
                Intent mainActivityIntent = new Intent(
                        InsertContactActivity.this, MainActivity.class);
        ...
        // if(mIsFromNotification){
        // Intent mainActivityIntent = new Intent(InsertContactActivity.this,
        // MainActivity.class);
        // startActivity(mainActivityIntent);
        // }
        // finish();
